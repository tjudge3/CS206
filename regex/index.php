<!--Little changed from the previous assignment for this page-->
<!doctype html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class='FlexContainerRow'>
            ...
            <div><input type="text" id="fname" name="firstname" placeholder="Your First name.." value="<?php print $firstname; ?>"><span class="error"><?php print $firstNameError; ?></span>
            <?php print $fnameErr; ?></span>
        </div>
</div>
<div class='FlexContainerRow'>
            <div><label for="lname">*Last name:</label></div>
            <div><input type="text" id="lname" name="lastname" placeholder="Your Last name.." value="<?php print $lastname; ?>"><span class="error"><?php print $lastNameError; ?></span>
            <?php print $lnameErr; ?></span>
        </div>
</div>
<div class='FlexContainerRow'>
